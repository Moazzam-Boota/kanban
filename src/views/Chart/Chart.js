...
const Users = () => {
  ...
  useEffect(() => {
    if (!inBetweenBreaks) {
      ...
      console.log('updatedShiftData', currentShiftOriginalCount, limitShift, allShiftsData[0], allShiftsData.length, limitShift - remainderDonePieces, limitShift - allShiftsDataRemainder, remainderDonePieces)
